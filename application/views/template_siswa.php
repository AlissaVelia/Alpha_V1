        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    Welcome, <br><?php echo $this->session->userdata('NM_SISWA'); ?> 
                    </div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?php echo base_url();?>index.php/siswa/profil"><i class="material-icons">person</i>Profile</a></li>
                           
                            <li> <a href="<?php echo base_url(); ?>index.php/siswa_login/logout"> <i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
