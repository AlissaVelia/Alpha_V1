    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">ALPHA SMK TELKOM</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?php echo base_url(); ?>assets/images/user1.png" width="48" height="48" alt="User" />
                </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>index.php/kurikulum/dashboard">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>index.php/data/data_kelas">   
                            <i class="material-icons">text_fields</i>
                            <span>Data Kelas</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>index.php/data/data_mapel">
                            <i class="material-icons">layers</i>
                            <span>Data Mapel</span>
                        </a>
                    </li>
                    <li>
                       <a href="<?php echo base_url(); ?>index.php/data/data_guru">
                    ...
                    <li>
                         <a href="<?php echo base_url(); ?>index.php/data/data_walisiswa">
                            <i class="material-icons">swap_calls</i>
                            <span>Data Walisiswa</span>
                        </a>
                        
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>index.php/data/data_siswa">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>index.php/laporan/laporan_kehadiran">
                            <i class="material-icons col-red">donut_large</i>
                            <span>Kehadiran Siswa</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>index.php/laporan/laporan_sikap">
