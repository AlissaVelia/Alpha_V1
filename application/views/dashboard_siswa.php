                    ...
                    <div class="card">
                        ...
                        <?php endforeach; ?>
                                ...
                                <div class="form-group" style="text-align: center">
                                   ...
                                   <p>Nama Wali Siswa : </p> <input type="text" value="<?php echo $walsis; ?>" placeholder="" class="form-control" disabled />
                                    <p>Kelas : </p> <input type="text" value="<?php echo $kls; ?>" placeholder="" class="form-control" disabled />
