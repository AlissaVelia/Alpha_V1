...
<body>
  <div class="wrapper">
    <div class="container">
        ...
        <form action="<?php echo base_url(); ?>index.php/walisiswa_login/login" method="post" class="login-form">

                                    <div class="form-group">
                                       
                                        <input type="text" name="NM_WALSIS" placeholder="USERNAME" class="form-username form-control" id="form-username">
                                    </div>
                                    <div class="form-group">
